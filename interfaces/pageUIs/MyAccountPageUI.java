...
public class MyAccountPageUI {
	...
	public static final String CUSTOMER_INFO = "//div[@class='page-title']";
	...
	public static final String SAVE_CUSTOMER_INFO = "//button[@id='save-info-button']";
	public static final String UPDATED_SUCCESS_INFO_MESSAGE = "// div[@class='bar-notification success']";
}
